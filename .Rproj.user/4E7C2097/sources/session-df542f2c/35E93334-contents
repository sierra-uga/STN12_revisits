...
library("fantaxtic")
library("ggpubr")
#if (!requireNamespace("BiocManager", quietly = TRUE))   # this is download the decontam package!
  #install.packages("BiocManager")                       # remove the # at the beginning to run
...
ps_d <- prune_taxa(!ps_decontam$contaminant, ps)
